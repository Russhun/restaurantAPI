...
CREATE TABLE IF NOT EXISTS `restaurantdb`.`order` (
  ...
  INDEX `fk_order_branch_seat1_idx` (`branch_seat_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_order_user1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_order_branch_seat1`
...
-- -----------------------------------------------------
-- Table `restaurantdb`.`product_status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurantdb`.`product_status` ;

CREATE TABLE IF NOT EXISTS `restaurantdb`.`product_status` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `status` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `restaurantdb`.`order_products`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurantdb`.`order_products` ;

CREATE TABLE IF NOT EXISTS `restaurantdb`.`order_products` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  INDEX `fk_user_menu_order_status1_idx` (`order_status_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_user_menu_order1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_menu_order_status1`
    FOREIGN KEY (`order_status_id`)
    REFERENCES `restaurantdb`.`product_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

...
CREATE TABLE IF NOT EXISTS `restaurantdb`.`user_menu` (
  ...
  INDEX `fk_cart_user1_idx` (`user_email` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `restaurantdb`.`order_has_user_menu`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurantdb`.`order_has_user_menu` ;

CREATE TABLE IF NOT EXISTS `restaurantdb`.`order_has_user_menu` (
  `order_id` INT NOT NULL,
  `user_menu_id` INT NOT NULL,
  PRIMARY KEY (`order_id`, `user_menu_id`),
  INDEX `fk_order_has_user_menu_user_menu1_idx` (`user_menu_id` ASC) VISIBLE,
  INDEX `fk_order_has_user_menu_order1_idx` (`order_id` ASC) VISIBLE,
  CONSTRAINT `fk_order_has_user_menu_order1`
    FOREIGN KEY (`order_id`)
    REFERENCES `restaurantdb`.`order` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_order_has_user_menu_user_menu1`
    FOREIGN KEY (`user_menu_id`)
    REFERENCES `restaurantdb`.`user_menu` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
